...
mixin _$PlayerSave {
 ...
 int get schemaVersion; int get coins; int get gems; String get selectedCharacterId; String get selectedWorldId; List<String> get ownedCharacterIds; List<String> get ownedWorldIds; String get selectedProfileAvatarId; String get selectedProfileFrameId; String get selectedTrailId; List<String> get ownedTrailIds; int get shieldCount; int get scoreBoosterCount; int get bestScore; Map<String, int> get worldScores; Map<String, int> get worldCompletedLevels; int get totalRuns; String? get lastDailyMissionDate; Map<String, int> get missionCounters; List<String> get claimedMissionIds; bool get dailyBonusClaimed; String? get lastDailyRewardDate; String? get lastWeeklyRewardKey; String? get lastWeeklyMissionKey; Map<String, int> get weeklyMissionCounters; List<String> get claimedWeeklyMissionIds; bool get hapticsEnabled; bool get musicEnabled; bool get sfxEnabled; bool get hintsEnabled;
...
@useResult
$Res call({
 int schemaVersion, int coins, int gems, String selectedCharacterId, String selectedWorldId, List<String> ownedCharacterIds, List<String> ownedWorldIds, String selectedProfileAvatarId, String selectedProfileFrameId, String selectedTrailId, List<String> ownedTrailIds, int shieldCount, int scoreBoosterCount, int bestScore, Map<String, int> worldScores, Map<String, int> worldCompletedLevels, int totalRuns, String? lastDailyMissionDate, Map<String, int> missionCounters, List<String> claimedMissionIds, bool dailyBonusClaimed, String? lastDailyRewardDate, String? lastWeeklyRewardKey, String? lastWeeklyMissionKey, Map<String, int> weeklyMissionCounters, List<String> claimedWeeklyMissionIds, bool hapticsEnabled, bool musicEnabled, bool sfxEnabled, bool hintsEnabled
});
...
/// Create a copy of PlayerSave
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? schemaVersion = null,Object? coins = null,Object? gems = null,Object? selectedCharacterId = null,Object? selectedWorldId = null,Object? ownedCharacterIds = null,Object? ownedWorldIds = null,Object? selectedProfileAvatarId = null,Object? selectedProfileFrameId = null,Object? selectedTrailId = null,Object? ownedTrailIds = null,Object? shieldCount = null,Object? scoreBoosterCount = null,Object? bestScore = null,Object? worldScores = null,Object? worldCompletedLevels = null,Object? totalRuns = null,Object? lastDailyMissionDate = freezed,Object? missionCounters = null,Object? claimedMissionIds = null,Object? dailyBonusClaimed = null,Object? lastDailyRewardDate = freezed,Object? lastWeeklyRewardKey = freezed,Object? lastWeeklyMissionKey = freezed,Object? weeklyMissionCounters = null,Object? claimedWeeklyMissionIds = null,Object? hapticsEnabled = null,Object? musicEnabled = null,Object? sfxEnabled = null,Object? hintsEnabled = null,}) {
...
as Map<String, int>,worldCompletedLevels: null == worldCompletedLevels ? _self.worldCompletedLevels : worldCompletedLevels // ignore: cast_nullable_to_non_nullable
...
as Map<String, int>,claimedWeeklyMissionIds: null == claimedWeeklyMissionIds ? _self.claimedWeeklyMissionIds : claimedWeeklyMissionIds // ignore: cast_nullable_to_non_nullable
as List<String>,hapticsEnabled: null == hapticsEnabled ? _self.hapticsEnabled : hapticsEnabled // ignore: cast_nullable_to_non_nullable
...
class _PlayerSave implements PlayerSave {
  const _PlayerSave({this.schemaVersion = 8, this.coins = 0, this.gems = 0, this.selectedCharacterId = 'default', this.selectedWorldId = 'default',  List<String> ownedCharacterIds = const ['default'],  List<String> ownedWorldIds = const ['default'], this.selectedProfileAvatarId = 'avatar_1', this.selectedProfileFrameId = 'frame_1', this.selectedTrailId = 'none',  List<String> ownedTrailIds = const ['none'], this.shieldCount = 0, this.scoreBoosterCount = 0, this.bestScore = 0,  Map<String, int> worldScores = const {},  Map<String, int> worldCompletedLevels = const {}, this.totalRuns = 0, this.lastDailyMissionDate,  Map<String, int> missionCounters = const {},  List<String> claimedMissionIds = const [], this.dailyBonusClaimed = false, this.lastDailyRewardDate, this.lastWeeklyRewardKey, this.lastWeeklyMissionKey,  Map<String, int> weeklyMissionCounters = const {},  List<String> claimedWeeklyMissionIds = const [], this.hapticsEnabled = true, this.musicEnabled = true, this.sfxEnabled = true, this.hintsEnabled = true}): _ownedCharacterIds = ownedCharacterIds,_ownedWorldIds = ownedWorldIds,_ownedTrailIds = ownedTrailIds,_worldScores = worldScores,_worldCompletedLevels = worldCompletedLevels,_missionCounters = missionCounters,_claimedMissionIds = claimedMissionIds,_weeklyMissionCounters = weeklyMissionCounters,_claimedWeeklyMissionIds = claimedWeeklyMissionIds;
...
@override@JsonKey() Map<String, int> get worldScores {
 ...
 final  Map<String, int> _worldCompletedLevels;
@override@JsonKey() Map<String, int> get worldCompletedLevels {
  if (_worldCompletedLevels is EqualUnmodifiableMapView) return _worldCompletedLevels;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_worldCompletedLevels);
}
...
@override@JsonKey() Map<String, int> get weeklyMissionCounters {
 ...
 final  List<String> _claimedWeeklyMissionIds;
@override@JsonKey() List<String> get claimedWeeklyMissionIds {
  if (_claimedWeeklyMissionIds is EqualUnmodifiableListView) return _claimedWeeklyMissionIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_claimedWeeklyMissionIds);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlayerSave&&(identical(other.schemaVersion, schemaVersion) || other.schemaVersion == schemaVersion)&&(identical(other.coins, coins) || other.coins == coins)&&(identical(other.gems, gems) || other.gems == gems)&&(identical(other.selectedCharacterId, selectedCharacterId) || other.selectedCharacterId == selectedCharacterId)&&(identical(other.selectedWorldId, selectedWorldId) || other.selectedWorldId == selectedWorldId)&&const DeepCollectionEquality().equals(other._ownedCharacterIds, _ownedCharacterIds)&&const DeepCollectionEquality().equals(other._ownedWorldIds, _ownedWorldIds)&&(identical(other.selectedProfileAvatarId, selectedProfileAvatarId) || other.selectedProfileAvatarId == selectedProfileAvatarId)&&(identical(other.selectedProfileFrameId, selectedProfileFrameId) || other.selectedProfileFrameId == selectedProfileFrameId)&&(identical(other.selectedTrailId, selectedTrailId) || other.selectedTrailId == selectedTrailId)&&const DeepCollectionEquality().equals(other._ownedTrailIds, _ownedTrailIds)&&(identical(other.shieldCount, shieldCount) || other.shieldCount == shieldCount)&&(identical(other.scoreBoosterCount, scoreBoosterCount) || other.scoreBoosterCount == scoreBoosterCount)&&(identical(other.bestScore, bestScore) || other.bestScore == bestScore)&&const DeepCollectionEquality().equals(other._worldScores, _worldScores)&&const DeepCollectionEquality().equals(other._worldCompletedLevels, _worldCompletedLevels)&&(identical(other.totalRuns, totalRuns) || other.totalRuns == totalRuns)&&(identical(other.lastDailyMissionDate, lastDailyMissionDate) || other.lastDailyMissionDate == lastDailyMissionDate)&&const DeepCollectionEquality().equals(other._missionCounters, _missionCounters)&&const DeepCollectionEquality().equals(other._claimedMissionIds, _claimedMissionIds)&&(identical(other.dailyBonusClaimed, dailyBonusClaimed) || other.dailyBonusClaimed == dailyBonusClaimed)&&(identical(other.lastDailyRewardDate, lastDailyRewardDate) || other.lastDailyRewardDate == lastDailyRewardDate)&&(identical(other.lastWeeklyRewardKey, lastWeeklyRewardKey) || other.lastWeeklyRewardKey == lastWeeklyRewardKey)&&(identical(other.lastWeeklyMissionKey, lastWeeklyMissionKey) || other.lastWeeklyMissionKey == lastWeeklyMissionKey)&&const DeepCollectionEquality().equals(other._weeklyMissionCounters, _weeklyMissionCounters)&&const DeepCollectionEquality().equals(other._claimedWeeklyMissionIds, _claimedWeeklyMissionIds)&&(identical(other.hapticsEnabled, hapticsEnabled) || other.hapticsEnabled == hapticsEnabled)&&(identical(other.musicEnabled, musicEnabled) || other.musicEnabled == musicEnabled)&&(identical(other.sfxEnabled, sfxEnabled) || other.sfxEnabled == sfxEnabled)&&(identical(other.hintsEnabled, hintsEnabled) || other.hintsEnabled == hintsEnabled));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,schemaVersion,coins,gems,selectedCharacterId,selectedWorldId,const DeepCollectionEquality().hash(_ownedCharacterIds),const DeepCollectionEquality().hash(_ownedWorldIds),selectedProfileAvatarId,selectedProfileFrameId,selectedTrailId,const DeepCollectionEquality().hash(_ownedTrailIds),shieldCount,scoreBoosterCount,bestScore,const DeepCollectionEquality().hash(_worldScores),const DeepCollectionEquality().hash(_worldCompletedLevels),totalRuns,lastDailyMissionDate,const DeepCollectionEquality().hash(_missionCounters),const DeepCollectionEquality().hash(_claimedMissionIds),dailyBonusClaimed,lastDailyRewardDate,lastWeeklyRewardKey,lastWeeklyMissionKey,const DeepCollectionEquality().hash(_weeklyMissionCounters),const DeepCollectionEquality().hash(_claimedWeeklyMissionIds),hapticsEnabled,musicEnabled,sfxEnabled,hintsEnabled]);
...
as Map<String, int>,worldCompletedLevels: null == worldCompletedLevels ? _self._worldCompletedLevels : worldCompletedLevels // ignore: cast_nullable_to_non_nullable
as Map<String, int>,totalRuns: null == totalRuns ? _self.totalRuns : totalRuns // ignore: cast_nullable_to_non_nullable
as int,lastDailyMissionDate: freezed == lastDailyMissionDate ? _self.lastDailyMissionDate : lastDailyMissionDate // ignore: cast_nullable_to_non_nullable
...
as Map<String, int>,claimedWeeklyMissionIds: null == claimedWeeklyMissionIds ? _self._claimedWeeklyMissionIds : claimedWeeklyMissionIds // ignore: cast_nullable_to_non_nullable
as List<String>,hapticsEnabled: null == hapticsEnabled ? _self.hapticsEnabled : hapticsEnabled // ignore: cast_nullable_to_non_nullable
as bool,musicEnabled: null == musicEnabled ? _self.musicEnabled : musicEnabled // ignore: cast_nullable_to_non_nullable
as bool,sfxEnabled: null == sfxEnabled ? _self.sfxEnabled : sfxEnabled // ignore: cast_nullable_to_non_nullable
as bool,hintsEnabled: null == hintsEnabled ? _self.hintsEnabled : hintsEnabled // ignore: cast_nullable_to_non_nullable
